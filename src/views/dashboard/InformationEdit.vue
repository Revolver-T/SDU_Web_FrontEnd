    ...
    <div class="table_center">
      <table class="content">
        ...
        <tr style="height: 40px">
          ...
          <td colspan="5">
            <el-input v-model="form.telephoneNumber" placeholder="请输入电话号码" style="width: 90%" />
          </td>
        </tr>
        <tr style="height: 40px">
          <td colspan="1" width="200">预信息</td>
          <td colspan="5">
            <el-input v-model="form.preEnrolmentInformation" placeholder="请输入预信息" style="width: 90%" />
          </td>
        </tr>
        <tr style="height: 40px">
          <td colspan="1" width="200">社会关系</td>
          <td colspan="5">
            <el-input v-model="form.social" placeholder="请输入社会关系" style="width: 90%" />
          </td>
        </tr>
