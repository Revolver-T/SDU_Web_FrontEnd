    ...
    <div class="table_center">
      <table class="content">
        ...
        <tr style="height: 40px">
          ...
          <td colspan="5">
            <el-input v-model="form.courseNum" placeholder="请输入课程号" style="width: 90%" :disabled="disbutton" />
          </td>
        </tr>
        <tr style="height: 40px">
          <td colspan="1" width="200">课程名称</td>
          <td colspan="5">
            <el-input v-model="form.courseName" placeholder="请输入课程名称" style="width: 90%" :disabled="disbutton" />
          </td>
        </tr>
        <tr style="height: 40px">
          <td colspan="1" width="200">成绩</td>
          <td colspan="5">
            <el-input v-model="form.score" placeholder="请输入成绩" style="width: 90%" />
          </td>
        </tr>
      </table>
    </div>
