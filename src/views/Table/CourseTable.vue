  ...
  <div class="base_form" style="padding-top: 15px">
    <div class="base_query_oneLine">
      <div class="query_left">
        ...
        <el-button class="orangeButton" size="small" @click="turndown()" :disabled="close">关闭选课</el-button>
        <el-button class="orangeButton" size="small" @click="open()" :disabled="!close">打开选课</el-button>
      </div>
...
export default {
  ...
  created() {
    axios.post('http://localhost:9090/home/weatherCancelChose')
      .then((res) => {
  ...
  methods: {
    ...
    turndown() {
      ...
      axios.post('http://localhost:9090/home/cancelChose', {
    ...
    open() {
      axios.post('http://localhost:9090/home/openChose', {
        username: this.username
      }).then((res) => {
        console.log(res.data)
        this.close = true
